...
export const submitNewsletter = (formData) => (dispatch) => {
    console.log('[Hybris Connector] Called submitNewsletter stub with arguments:', formData)

    return Promise.resolve()
}
export const getSearchSuggestions = (query) => (dispatch) => {
    console.log('[Hybris Connector] Called getSearchSuggestions stub with arguments:', query)
