...
import {getApiEndPoint, getRequestHeaders, getStorage} from './config'
...
export const storeAuthToken = (authorization) => {
    if (authorization) {
        getStorage().set(AUTH_KEY_NAME, authorization)
    }
}

export const getAuthToken = () => {
    return getStorage().get(AUTH_KEY_NAME)
}

export const deleteAuthToken = () => {
    getStorage().remove(AUTH_KEY_NAME)
}

export const deleteBasketID = () => {
    getStorage().remove(BASKET_KEY_NAME)
}

export const getBasketID = () => {
    return getStorage().get(BASKET_KEY_NAME)
}
...
export const storeBasketID = (basketID) => {
    ...
    getStorage().set(BASKET_KEY_NAME, basketID)
}
